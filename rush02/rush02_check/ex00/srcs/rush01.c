...
/*   Updated: 2021/09/05 19:31:25 by jtian            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft.h"

void		print_rush1(char *chars, int d, char **print)
{
	char a;
	char b;
	char c;
...
void		ft_rush01(int x, int y, char **print)
{
	int		temp;
	int		tempy;
